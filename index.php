...
<html lang="en">
    ...
    echo '<a href = "connexion.php" class="btn blue animated pulse" > Uploadez vos fichiers </a > ';
           ...
           <br><br>
            <div class="tableimg">
                <ul id="gallery">
                    <li><a href="#"><img src="img/1.png" width="200" height="150px" alt="image01"></a></li>
                    <li><a href="#"><img src="img/1.png" width="200" height="150px" alt="image02"></a></li>
                    <li><a href="#"><img src="img/1.png" width="200" height="150px" alt="image03"></a></li>
                    <li><a href="#"><img src="img/1.png" width="200" height="150px" alt="image04"></a></li>
                    <li><a href="#"><img src="img/1.png" width="200" height="150px" alt="image05"></a></li>
                </ul>
            </div>
