...
<html lang="en">
    <head>
        ...
        <title>HostYourPics | hébergement gratuit d'images</title>
    </head>
    <body>
        <header>
            ...
            <nav class="cd-main-nav-wrapper">
                <ul class="cd-main-nav">
                    <li><a href="inscription.html"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Inscription</a></li>
                    <li><a href="connexion.html"><i class="fa fa-sign-in" aria-hidden="true"></i> Connexion</a></li>
